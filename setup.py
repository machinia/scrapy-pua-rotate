...
setup(
    name='scrapy-pua-rotate',

    version='0.0.1',

    description='Random proxy and user-agent middleware for scrapy',
    long_description=long_description,

    url='https://github.com/machinia/scrapy-pua-rotate',
    ...
    keywords='scrapy proxy user-agent middleware random',
